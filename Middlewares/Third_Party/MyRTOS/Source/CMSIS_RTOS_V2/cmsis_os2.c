 ...
 *---------------------------------------------------------------------------*/
#include "MyRTOS.h"
#include <myrtos_mpool.h>             // osMemoryPool definitions
#include <myrtos_os2.h>               // Configuration check and setup
#include "checkpoint.h"
#include "power_sim.h"
#include "MyRTOS.h"
#include "task.h"
#include "../../../MyRTOS/Source/CMSIS_RTOS_V2/cmsis_os2.h"                  // ::CMSIS:RTOS2

#include <string.h>

#include "cmsis_compiler.h"             // Compiler agnostic definitions

#include "../../../MyRTOS/Source/include/MyRTOS.h"                   // ARM.FreeRTOS::RTOS:Core
...
void SysTick_Handler (void) {
  ...
  /* Always call the RTOS tick handler – it checks the scheduler state internally */
  xPortSysTickHandler();

  // ==========================================
  // YOUR INNOVATION: Power simulation and checkpoint
  // ==========================================
  PowerSim_Update();
  Checkpoint_PowerMonitor();
}
#endif
#endif
